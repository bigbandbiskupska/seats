...
class TicketForbiddenParameterUpdatedTest extends TestCaseWithDatabase {
    ...
    public function setUpClass() {
        ...
        $this->setUpRequestInput(array(
            'note' => 'test',
            'updated_at' => DateTime::from("2017-01-01 00:00:00"), // invalid parameter (can't change date)
        ));
...
run(new TicketForbiddenParameterUpdatedTest($container));
